        ...
        while not done:
            ...
            if done:
                if 'out_of_bound' in info and info['out_of_bound']:
                    prYellow('Episode {} - step {} - eps_rew {} - Info: out of bound - control mode: {} - traj: {}'.format(i_episode, episode_steps, episode_reward, args.control_mode, args.traj))
                    
                elif 'reach_max_steps' in info and info['reach_max_steps']:
                    prYellow('Episode {} - step {} - eps_rew {} - Info: reach max steps - control mode: {} - traj: {}'.format(i_episode, episode_steps, episode_reward, args.control_mode, args.traj))
